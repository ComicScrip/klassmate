...
export default function ShowActivityPage() {
  ...
  const handleCompletionStatusChange = (input) => {
  ...
  useEffect(() => {
    ...
    socket.on('activityAttendees', (users) => {
      setActivityAttendees(users);
      const me = users.find(
    ...
    socket.on('activityUpdated', setActivity);
      ...
      <div>
        ...
        <div className="flex mt-10 justify-between">
          <Button
            ...
            color="primary"
            startIcon={<DoneIcon />}
            onClick={() => handleCompletionStatusChange('done')}
          >
            I'm done !
          </Button>
          <Button
            ...
            onClick={() => handleCompletionStatusChange('stuck')}
          >
            I'm stuck
          </Button>
        </div>
